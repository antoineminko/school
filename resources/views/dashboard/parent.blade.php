...
@section('title', 'Tableau de Bord Parent - Schoolease')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="alert alert-info">
                ...
                <p class="mb-0">
                    En tant que parent, vous utilisez les mêmes identifiants que votre enfant pour accéder à son tableau de bord. 
                    Vous pouvez suivre ses progrès, ses devoirs et ses notes en temps réel.
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <i class="fas fa-calendar-alt me-2"></i>Emploi du Temps de votre enfant
                    </h6>
                </div>
                <div class="card-body">
                    ...
                    <div class="list-group list-group-flush">
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small class="text-muted">M. Dupont - 28/09</small>
                            </div>
                            <div class="text-end">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small class="text-muted">Mme Durand - 25/09</small>
                            </div>
                            <div class="text-end">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small class="text-muted">Mme Martin - 22/09</small>
                            </div>
                            <div class="text-end">
                                <span class="badge bg-success">18/20</span>
                                <br>
                                <small class="text-success">Très bien</small>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <i class="fas fa-comments me-2"></i>Communication avec l'École
                    </h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div class="card border-primary">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted">Appelez l'école pour toute question urgente</p>
                                    <a href="tel:+33123456789" class="btn btn-outline-primary">Appeler</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="card border-success">
                                <div class="card-body text-center">
                                    ...
                                    <h5>Email</h5>
                                    <p class="text-muted">Envoyez un email aux professeurs</p>
                                    <a href="mailto:contact@ecole.fr" class="btn btn-outline-success">Écrire</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="card border-info">
                                <div class="card-body text-center">
                                    ...
                                    <h5>Rendez-vous</h5>
                                    <p class="text-muted">Prendre rendez-vous avec un professeur</p>
